...
`run_risk_discovery`, `score_risks_job`, `run_risk_tagging_job`,
`run_risk_owner_assignment_job`) — the business logic is unchanged; only
dispatch and orchestration are new.
